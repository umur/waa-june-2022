...
const addStudent = async () => {
  ...
  await postFetch(`${serverUrl}/v4/students`, body);
...
const editStudent = async () => {
  ...
  await putFetch(`${serverUrl}/v4/students/${id}`, body);
...
const deleteStudent = async () => {
  ...
  await deleteFetch(`${serverUrl}/v4/students/${deleteId}`);
